# ANALYTICS_REMOTE_ASSURANCE_FRONTEND_COMPONENT_MAP_v1.0.md

## Analytics Remote Assurance - Frontend Component Map
**Version**: 1.0  
**Date**: 2025-12-04

## Route Structure
```
/app/analytics-remote-assurance/
...
```
/components/analytics-remote-assurance/
