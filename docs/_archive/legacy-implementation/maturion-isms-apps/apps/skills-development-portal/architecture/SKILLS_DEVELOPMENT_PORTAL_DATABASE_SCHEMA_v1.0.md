# SKILLS_DEVELOPMENT_PORTAL_DATABASE_SCHEMA_v1.0.md

## Skills Development Portal - Database Schema
**Version**: 1.0  
**Date**: 2025-12-04

## Schema Overview
All tables follow naming convention: `skills_development_portal_*`
