...
2. **Architecture References**
   - Wave 2 Architecture Specification (Governance Advanced section)
...
### Gate Requirements (GATE-SUBWAVE-2.7)
...
- Later subwaves BLOCKED until GATE-SUBWAVE-2.7 PASS
...
```bash
pytest tests/wave2_0_qa_infrastructure/test_governance_advanced_*.py -v
```
...
3. **Documentation**
   - Builder QA Report (`WAVE_2.7_BUILDER_COMPLETION_REPORT.md`)
...
**Rollout Plan Reference:** WAVE_2_ROLLOUT_PLAN.md Section II, Subwave 2.7

---

**END SUBWAVE 2.7 BUILDER SUB-ISSUE SPECIFICATION**
