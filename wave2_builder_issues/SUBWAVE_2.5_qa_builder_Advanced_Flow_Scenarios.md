...
### Gate Requirements (GATE-SUBWAVE-2.5)
...
- ⏳ **GATE-SUBWAVE-2.3, 2.4 PASS** — BLOCKING

### Downstream Dependencies
- Later subwaves BLOCKED until GATE-SUBWAVE-2.5 PASS
...
### Blocking Condition
- **BLOCKED** until GATE-SUBWAVE-2.3, 2.4 PASS
...
3. **Documentation**
   - Builder QA Report (`WAVE_2.5_BUILDER_COMPLETION_REPORT.md`)
...
**END SUBWAVE 2.5 BUILDER SUB-ISSUE SPECIFICATION**
